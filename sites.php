         ...
         <div class="row">
           <div class="col-md-8 col-md-offset-2 text-center">
             ...
             <div class="col-md-4 text-left">
               ...
               <p>I developed the site using Kleo a WordPress / BuddyPress community theme as a starting point, then designed pages in HTML / CSS and Visual Composer. For the Membership / Gamification features, I used a combination of BuddyPress and BadgeOS.</p>
             </div>
             <div class="col-md-4 text-left">
               <p><strong>FROM THE BEGINNING</strong></p>
               <p>I worked closely with my client from the beginning of the project to where it is today. From finding the best suited hosting company to planning the User experience, through to UI Design & implementation. Development started in March 2016, we launched in December 2016.</p>
             </div>
             <div class="col-md-4 text-left">
